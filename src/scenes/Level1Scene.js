...
export default class Level1Scene extends Phaser.Scene {
    ...
    createEnemies() {
        ...
        const minicat1 = new MiniCat(this, 300, 200, 0xff6b6b); // Rouge
        const minicat2 = new MiniCat(this, 450, 200, 0x4ecdc4); // Cyan
        const minicat3 = new MiniCat(this, 550, 200, 0xffe66d); // Jaune
    ...
    update(time, delta) {
        if (this.player) {
            ...
            if (this.checkLevelEnd && this.player.x > 600) { // ← Change 1800 à 600
