...
export default class Level4Scene extends Phaser.Scene {
    ...
    create() {
        ...
        // Créer la tilemap
        this.createTilemap();
        //this.add.rectangle(15, 50, 30, 100, 0xff0000, 0.2).setDepth(999);
    ...
    update(time, delta) {
        if (this.player) {
            ...
            if (this.checkLevelEnd && this.player.x >= 0 && this.player.x <= 30 && this.player.y >= 0 && this.player.y <= 100) { // ← Change 1800 à 600
