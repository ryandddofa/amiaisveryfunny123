...
export default class Intro1Scene extends Phaser.Scene {
    constructor() {
        super({ key: 'Intro1Scene' });
    }
    ...
    create() {
        ...
        this.dialogues = [
            { speaker: '', text: 'During a peaceful date at McDonald\'s...', color: '#ebebeb' },
            { speaker: 'Amia', text: 'Bro ryan this burger is amazing! can i peg you?', color: '#ff69b4', portrait: 'a1' },
            { speaker: 'Ryan', text: 'I know right esti? Best McDonald\'s ever!', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: 'Gia', text: 'Woof woof! (Can I have fries?)', color: '#ffff00', portrait: 'gia-portrait' },
            { speaker: 'Amia', text: 'Of course Gia! Here you go~', color: '#ff69b4', portrait: 'a1' },
            { speaker: 'Gia', text: 'WOOF WOOO FOW OFOOWOOF WOOF', color: '#ffff00', portrait: 'gia-portrait' },
            { speaker: 'Ryan', text: 'yO Gia Chill ! It\'s only fries...', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: 'Amia', text: 'Ryan did you hear that??????', color: '#ff69b4', portrait: 'a1' },
            { speaker: 'Ryan', text: 'Yeah I think that was my fart lol', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: 'Amia', text: 'bro', color: '#ff69b4', portrait: 'a1' },
            { speaker: 'Gia', text: 'WOOO FOW OFOOWOOF WOOF WOOF WOOO FOW OFOOWOOF WOOF ', color: '#ffff00', portrait: 'gia-portrait' },
            { speaker: 'Amia', text: 'You heard it too Gia?!', color: '#ff69b4', portrait: 'a1' },
            { speaker: 'Ryan', text: 'Wait I think I heard it too... Sounds like fireworks?', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: 'Gia', text: 'WOOF!!!!!', color: '#ffff00', portrait: 'gia-portrait' },
            { speaker: '', text: '*BOOM*', color: '#ebebeb' },
            { speaker: 'Amia', text: 'Holy shit Ryan I think it\'s explosions!!', color: '#ff69b4', portrait: 'a2' },
            { speaker: 'Ryan', text: 'Ain\'t no way, this is St-Eustache... There is no way someone would bomb St-Eustache lol', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: '', text: '*KABOOOOM*', color: '#ebebeb' },
            { speaker: 'Amia', text: 'HOLY SHIT', color: '#ff69b4', portrait: 'a3' },
            { speaker: 'Ryan', text: 'WHAT THE FUCK', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: 'Gia', text: 'what is happening wtf', color: '#ffff00', portrait: 'gia-portrait' },
            { speaker: 'Amia', text: 'Gia you can speak now?..', color: '#ff69b4', portrait: 'a1' },
            { speaker: 'Gia', text: 'Woof.', color: '#ffff00', portrait: 'gia-portrait' },
            { speaker: 'Ryan', text: 'okay bro', color: '#4643ec', portrait: 'ryan-portrait' },
            { speaker: 'Amia', text: 'We should head outside to see whats happening...', color: '#ff69b4', portrait: 'a1' },
            { speaker: '', text: 'And so they head outside...', color: '#ebebeb' },
        ];
